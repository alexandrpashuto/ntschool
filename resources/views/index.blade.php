...
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="slide_description_wrapper">
                        <div class="slide_description">
                            ...
                            <div class="intro-layer to_animate" data-animation="fadeInUp">
                                <p>Strip steak short ribs picanha shoulder bresaola. Pork belly brisket shankle short
                                    loin.</p>
                            </div>
                            <div class="intro-layer to_animate" data-animation="fadeInUp">
    ...
    <section id="about" class="ls section_padding_top_100 section_padding_bottom_100">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p>
                        Drumstick flank pork chop pastrami tenderloin. Turkey bacon cow beef ribs salami pork loin kevin
    ...
    <section id="team" class="ls page_portfolio section_padding_top_130 section_padding_bottom_100">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="owl-carousel with_shadow_items" data-nav="true" data-dots="false" data-items="3"
                         data-responsive-lg="3" data-margin="30" data-loop="true">
                        ...
                        <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                            ...
                            <div class="item-content">
                                ...
                                <p>
                                    Rosie is andouille picanha ball tip boudin cow bacon chuck swine pig tri-tip biltong
                                    bresaola.
                                </p>
                        ...
                        <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                            ...
                            <div class="item-content">
                                ...
                                <p>
                                    Estelle is biltong picanha capicola, burgdoggen spare ribs leberkas meatloaf. Pig
                                    bresaola t-bone.
                                </p>
                        ...
                        <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                            ...
                            <div class="item-content">
                                ...
                                <p>
                                    Alberta is sed in ribeye nisi cillum. Ad leberkas labore cow, incididunt deserunt
                                    cillum aute elit.
                                </p>
                        ...
                        <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                            ...
                            <div class="item-content">
                                ...
                                <p>
                                    Bernard is rump laborum enim magna velit ipsum boudin. Short loin ipsum officia ea
                                    nisi dolor.
                                </p>
                        ...
                        <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                            ...
                            <div class="item-content">
                                ...
                                <p>
                                    Frank is mollit ipsum cupidatat commodo occaecat pariatur in eu porchetta landjaeger
                                    turkey aliqua.
                                </p>
    ...
    <section id="appointment"
             class="ds page_appointment background_cover section_padding_top_100 section_padding_bottom_100">
        <div class="container">
            <div class="row">
                    ...
                    <form class="contact-form row columns_margin_bottom_20" method="post" action="./">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" aria-required="true" size="30" value="" name="pickup-name"
                                       id="pickup-name" class="form-control" placeholder="Full Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" aria-required="true" size="30" value="" name="pickup-phone"
                                       id="pickup-phone" class="form-control" placeholder="Phone Number">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group select-group">
                                ...
                                <select aria-required="true" id="pickup-date" name="pickup-date"
                        ...
                        <div class="col-md-2">
                            <div class="form-group select-group">
                                ...
                                <select aria-required="true" id="pickup-time" name="pickup-time"
                                        class="choice empty form-control">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea aria-required="true" rows="3" cols="45" name="pickup-message"
                                          id="pickup-message" class="form-control" placeholder="Message"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="contact-form-submit topmargin_10">
                                <button type="submit" id="pickup-_submit" name="contact_submit"
                                        class="theme_button color3 wide_button">Make an Appointment
                                </button>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="grey">
                        Do swine ipsum leberkas, chicken drumstick jerky frankfurter reprehe voluptate ea t-bone lorem
                        pork loin!
                    </p>
                    <p>
                        Capicola mollit swine aute, minim cupim frankfurter kielbasa. Chicken elit magna dolor bresaola
                        velit. Qui est ball tip pork belly pariatur eu strip steak consequat labore aliqua salami ground
                        round. Sint aliquip venison est shoulder swine exercitation dolor.
                    </p>
    ...
    <section id="reviews"
             class="cs main_color3 parallax page_testimonials section_padding_top_100 section_padding_bottom_100">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2 class="section_header with_icon icon_color">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <div class="owl-carousel testimonials-owl-carousel" data-responsive-lg="1" data-responsive-md="1"
                         data-responsive-sm="1" data-dots="true" data-nav="false">

                        <blockquote class="with_quotes text-center">
                            <img src="images/faces/01.jpg" alt=""/> With the notion of just how much pet do hate sitting
                            in the groomer's chair, Estelle Marsh undid it all for Enny!
                            <div class="item-meta">
                ...
                <div class="col-md-4 col-sm-6">
                    <article class="vertical-item content-padding with_shadow text-center rounded overflow-hidden">
                        ...
                        <div class="item-content">
                            ...
                            <p>
                                Fatback jerky pig sirloin. Beef landja pork beef ribs kielbasa shoulder tongue pig
                                venison pork chop.
                            </p>
